...
<!-- side bar ends--> 
    ...
    <a class="navbar-brand" href="index.blade.php" style="padding-left:50px;color:white;">Egnitia Admissions</a> 
    </div> 
...
<!-- SEARCH BY COURSE-->     
<div> 
  <div class="col-md-5" style="float:center; padding-left:50px"> 
  <div class="form-group"> 
<h2><strong>Choose Your Field Of Interest :</strong></h2> 
<select name="course_group" id="course-group-url-alias" class="form-control input-lg"><option value="aerospace-and-aeronautical-engineering">Aerospace Engineering</option><option value="analytics">Analytics</option><option value="architecture">Architecture</option><option value="arts-and-media">Arts and Media</option><option value="agricultural-engineering">Biological / Agricultural</option><option value="biomedical-engineering">Biomedical Engineering</option><option value="chemical-engineering">Chemical / Petroleum</option><option value="civil-and-structural-engineering">Civil and Structural Engineering</option><option value="commerce-finance-actuarial">Commerce / Finance / Actuarial</option><option value="computer-science-engineering">Computer Science and Engineering</option><option value="dental">Dental</option><option value="education-languages-and-counselling">Education / Languages / Counselling</option><option value="electrical-electronics-telecomm">Electrical / Electronics / Telecomm</option><option value="engineering-management">Engineering Management (MEM)</option><option value="environmental-engineering">Environmental / Mining</option><option value="financial-engineering">Financial Engineering</option><option value="general-and-international-law">General Law / International Law</option><option value="administrative-studies">Government / Administrative</option><option value="healthcare">Healthcare</option><option value="human resources">Human Resources</option><option value="humanities-journalism">Humanities / Journalism</option><option value="industrial-and-operations-engineering">Industrial Engineering and Operations</option><option value="international-management">International Management</option><option value="management-information-system">Management Information System (MIS)</option><option value="marketing">Marketing</option><option value="material-science-and-engineering">Material Science and Engineering</option><option value="management">MBA / Management</option><option value="mechanical-and-automobile-engineering">Mechanical and Automobile Engineering</option><option value="nano-nuclear-power-engineering">Nano / Nuclear / Power</option><option value="nursing">Nursing</option><option value="pharmacy">Pharmacy</option><option value="pure-sciences">Pure Sciences</option><option value="veterinary-science">Veterinary Science</option></select> </div> 
</div> 
</div> 
<!-- COURSE SEARCH ENDS --> 
...
<div class="form-group"> 
<h2><strong>Choose the University :</strong></h2> 
<select name="country" id="country-url-alias" class="form-control input-lg"><option value="oxford">University of Oxford</option> 
<option value="harvard">Harvard University</option><option value="mit">Massachusetts Institute of Technology</option> 
<option value="california">University of california</option><option value="stanford">Stanford university</option> 
<option value="cambridge">University of Cambridge</option><option value="imperial">Imperial college of London</option> 
<option value="chicago">University of Chicago</option> 
</select> </div> 
</div> 
<div class="col-sm-2"> 
<h2><br></h2> 
<button class="btn btn-lg btn-warning" id="search-universities-home-button" class="searchbtn" type="button">SEARCH</button> 
</div> 
</form> </div> 
</div> 
</div> 
  ...
  <div class="row" > 
    ...
    <div class="col-md-4"> 
            ...
            <a href="california.jpg"> 
                <img src="california.jpg" alt="California" style="width:100%;height:135px;"> 
                <div class="caption"> 
                <a href="california.html" style="color:blue; font-size:18px">University of California</a> 
                </div> 
            </a> 
            </div> 
        </div> 
    ...
    <div class="col-md-4"> 
          <div class="thumbnail"> 
           ...
           <img src="cambridge.jpg" alt="Cambridge" style="width:100%;height:135px;"> 
           <div class="caption"> 
           <a href="cambridge.html" style="color:blue; font-size:18px">University of Cambridge</a> 
           </div> 
           </a> 
           </div> 
     </div> 
      ...
      <div class="col-md-4"> 
            <div class="thumbnail"> 
            <a href="chicago.jpg"> 
                <img src="chicago.jpg" alt="Chicago" style="width:100%;height:135px;"> 
                <div class="caption"> 
                <a href="chicago.html" style="color:blue; font-size:18px">University of Chicago</a> 
                </div> 
            </a> 
            </div> 
        </div> 
        ...
        <div class="col-md-4"> 
                <div class="thumbnail"> 
                <a href="harvard.jpg"> 
                    <img src="harvard.jpg" alt="Harvard" style="width:100%;height:135px;"> 
                    <div class="caption"> 
                    <a href="harvard.html" style="color:blue; font-size:18px">Harvard University</a> 
                    </div> 
                </a> 
                </div> 
            </div> 
...
<?php 
    if($_SESSION["logged_in"] == true) 
        <button type="submit">fejhbfjheb</button> 
?> 
