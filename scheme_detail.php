    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <div class="row" >
                <div class="row">
                    <div class="col-md-9">
                        <h2>Mahila Samakhya Programme</h2>
                        <p>Ministry of Human Resource Development (MHRD), Government of India</p>
                    </div>
                    <div class="col-md-3">
                        <button class="btn"><a href="http://mhrd.gov.in/mahila-samakhya-programme"  target="_blank">Open Govt Website</a></button>
                    </div>
                </div>
                <br>
                ...
                <p>
                    Provision of educational opportunities for women and girls in rural areas, particularly of women from socially and economically marginalised groups.
                </p>
                ...
                <ol>
                    <li>Contact to District Implementation Unit</li>
                    <li>Contact to State Programme Office</li>
                    <li>Contact to National Project Office</li>
                                                ...
                                                <form action="student_details.php" method="POST" class="pb-modalreglog-form-reg" name="validate" onsubmit="validateForm()">
                                                    ...
                                                    <div class="form-group" style="float: left">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group pb-modalreglog-input-group">
                                                                <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                                                                <input type="text" class="form-control" id="PhoneNo" name="PhoneNo" placeholder="Religion." required >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group pb-modalreglog-input-group">
                                                                <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                                                                <input type="text" class="form-control" id="PhoneNo" name="PhoneNo" placeholder="Caste." required >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
